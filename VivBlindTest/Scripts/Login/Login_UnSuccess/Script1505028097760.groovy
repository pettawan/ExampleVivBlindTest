...
'check when login unsuccess'
checklogin = WebUI.getText(findTestObject('Login_Page/strong_Warning_Message'))
WebUI.verifyMatch(checklogin, 'กรุณากรอก รหัสสมาชิก หรือ รหัสผ่านให้ถูกต้อง', false)
