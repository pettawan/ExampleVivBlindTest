...
InternalData data = findTestData("LoginTestData")
...
'Input username'
WebUI.setText(findTestObject('Login_Page/input_EMAIL'), data.internallyGetValue("username", index))

'Input password'
WebUI.setText(findTestObject('Login_Page/input_password'), data.internallyGetValue("password", index))
