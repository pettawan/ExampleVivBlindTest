...
'Click to Home Page'
WebUI.click(findTestObject('Login_Page/link_Home_Page'))
WebUI.waitForPageLoad(5)

'Input email'
WebUI.setText(findTestObject('Login_Page/input_EMAIL'), randomEmail)
...
'Check the message when login'
loginMessage = WebUI.getText(findTestObject('Login_Page/strong_Email'))
WebUI.verifyMatch(loginMessage, "กรุณา ยืนยัน e-mail", false)
